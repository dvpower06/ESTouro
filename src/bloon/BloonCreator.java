...
public class BloonCreator {
	...
	public Bloon criarMetal() {
		...
		ComponenteVisual imagemPop = getImagemPop();
		// TODO FEITO metal tem de ser imune a perfurantes
		BloonMetal metal = new BloonMetal(imagem, imagemPop, 3, 5, 7);
	...
	public Bloon criarBarro() {
		...
		ComponenteVisual imagemPop = getImagemPop();
		// TODO FEITO barro tem de ser imune a perfurantes
		BloonBarro barro = new BloonBarro(imagem, imagemPop, 3.5f, 4, 7);
	...
	public Bloon criarPreto() {
		...
		ComponenteVisual imagemPop = getImagemPop();
		// TODO FEITO preto tem de ser imune a explosões
		BloonPreto black = new BloonPreto(imagem, imagemPop, 4, 6, 7);
	...
	public Bloon criarBranco() {
		...
		ComponenteVisual imagemPop = getImagemPop();
		// TODO FEITO branco tem de ser imune a explosões
		BloonBranco black = new BloonBranco(imagem, imagemPop, 4, 6, 7);
	...
	public Bloon criarZeppelinMetal() {
		...
		// TODO FEITO o Zeppelin metal tem de ser imune a perfurantes
		BloonMetalZep metalZep = new BloonMetalZep(imagem, imagemPop, 2.3f, 30, 45, 30);

		// TODO FEITO o verde e o amarelo têm de ter uma armadura que rebenta ao fim de 8
		// contactos
		Bloon verde = criarVerde();
		BloonArmadura verdeArmadura = new BloonArmadura(verde, armaduraImg, 8);
		metalZep.addBloonProvavel(verdeArmadura);
		Bloon amarelo = criarAmarelo();
		BloonArmadura amareloArmadura = new BloonArmadura(amarelo, armaduraImg, 8);
		metalZep.addBloonProvavel(amareloArmadura);	
		return metalZep;
	}
	...
	public Bloon criarZeppelinPreto() {
		...
		// TODO FEITO o Zeppelin preto tem de ser imune a explosões
		BloonPretoZep pretoZep = new BloonPretoZep(imagem, imagemPop, 2.7f, 30, 45, 30);

		// TODO FEITO o amarelo e o rosa devem ter um escudo que parte ao fim de 12 contactos
		Bloon amarelo = criarAmarelo();
		BloonArmadura amareloEscudo = new BloonArmadura(amarelo, escudoImg, 12);
		pretoZep.addBloonProvavel(amareloEscudo);
		Bloon rosa = criarRosa();
		BloonArmadura rosaEscudo = new BloonArmadura(rosa, escudoImg, 12);
		pretoZep.addBloonProvavel(rosaEscudo);
		return pretoZep;
	}
}
